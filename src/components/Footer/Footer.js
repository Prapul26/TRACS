                ...
                <div className='download-container'>
                    ...
                    <div className='socilaMediaStore-container'>
                        <div className='f-holder'>
                            <button> <span style={{ marginLeft: "-2px" }}><a href="https://www.facebook.com/h7network" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit" }}><FaFacebook /></a></span></button>
                        </div>
                        <div className='x-holder'><button> <span style={{ marginLeft: "-2px" }}><a href="https://x.com/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit" }}><FaXTwitter /></a></span></button></div>
                        <div className='t-holder'><button> <span style={{ marginLeft: "-1px" }}><a href="https://www.linkedin.com/company/h7network/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit" }}><FaLinkedinIn /></a></span>   </button></div>
                    </div>
                </div>
